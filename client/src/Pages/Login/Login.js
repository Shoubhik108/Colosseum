                        ...
                        <div className="p-4 space-y-10 md:space-y-0 md:grid md:grid-cols-2">
                            ...
                            <div className="md:flex md:flex-col md:justify-center lg:pr-16">
                                ...
                                <div className="relative mt-4 font-sourceSerifPro outline ">
                                    <input type="text" name="username" placeholder=" "  className="block w-full pb-2 pl-3 text-lg text-gray-800 placeholder-gray-400 bg-transparent border-b-2 border-gray-400 appearance-none rounded-xl focus:border-green-400 focus:outline-none" />
                                ...
                                <div className="relative mt-8 font-sourceSerifPro outline ">
                                    <input type="password" name="username" placeholder=" " className="block w-full pb-2 pl-3 text-lg text-gray-800 placeholder-gray-400 bg-transparent border-b-2 border-gray-400 appearance-none rounded-xl focus:border-green-400 focus:outline-none" required />
                                ...
                                <div className="grid justify-center grid-cols-1 gap-1 md:gap-4 mx-4 md:grid-cols-2">
                                    ...
                                    <button  className="h-12 px-8 text-base font-semibold tracking-wider text-white border rounded-full shadow-sm font-fontVollkorn my-6 bg-blue-800 hover:shadow-lg">Sign In</button>

                                    <button  className="h-12 px-8 text-base font-semibold tracking-wider text-blue-800  rounded-full shadow-sm border-2 border-blue-800 font-fontVollkorn my-6 hover:shadow-lg">Sign Up</button>
                                </div>
